...
public class TestCreateInstructorWithCourseDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			tempInstructor.addCourse(new Course("Java core basis"));

			tempInstructor.addCourse(new Course("Learning Java by Hard way"));
